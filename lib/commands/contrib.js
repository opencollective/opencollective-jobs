...
exports.builder = function contribBuilder (yargs) {
  return yargs
    .usage('$0 contrib <org..>')
    .example('$0 contrib --external OpenCollective', 'Output all repos that members of the OpenCollective org have contributed to recently')
    .example('$0 contrib --private mochajs yeoman', 'Output all contributions to non-org repos by public and private members of orgs "mochajs" and "yeoman"')
